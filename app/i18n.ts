...
export const siteCopy: Record<Language, SiteCopy> = {
  ru: {
    ...
    frames: [
      ['/media/heart-02.webp', 'HEART ATTACK — подиумный перформанс'],
      ['/media/veins-02.webp', 'VEINS OF VANITY — подиумный образ'],
      ['/media/pony-02.webp', '«PONY» PROJECT — деталь костюма'],
      ['/media/games-02.webp', 'PLAY TIME IS OVER — сцена на подиуме'],
      ['/media/md-02.webp', 'MD — портретное исследование'],
      ['/media/style-02.webp', 'STYLING — тёмный редакционный портрет'],
      {
        type: 'video',
  ...
  en: {
    ...
    frames: [
      ['/media/heart-02.webp', 'HEART ATTACK — runway performance'],
      ['/media/veins-02.webp', 'VEINS OF VANITY — runway look'],
      ['/media/pony-02.webp', '«PONY» PROJECT — costume detail'],
      ['/media/games-02.webp', 'PLAY TIME IS OVER — runway scene'],
      ['/media/md-02.webp', 'MD — portrait study'],
      ['/media/style-02.webp', 'STYLING — dark editorial portrait'],
      {
        type: 'video',
        src: '/media/pony-selected-frame.mp4',
        poster: '/media/pony-selected-frame.jpg',
